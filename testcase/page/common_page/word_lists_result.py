...
from testcase.common.base_word_lists_result import WordListsResultPage


# class New_base(BasePage):
#     pass


class Word_Lists_ResultPage(WordListsResultPage):
    """
    生词表页ID
    """
    ...
    words_list_done_button_id = (By.ID, "com.langlib.cee:id/fragment_word_profi_done_tv")
